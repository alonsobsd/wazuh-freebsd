...
INSTALLATION_PATH=${1}
SERVICE=/Library/LaunchDaemons/com.dns.overwatch.plist
...
launchctl unload /Library/LaunchDaemons/com.dns.overwatch.plist 2> /dev/null
...
echo '<?xml version="1.0" encoding="UTF-8"?>
 ...
 <plist version="1.0">
     <dict>
         <key>Label</key>
         <string>com.dns.overwatch</string>
