...
/* FIM default values */
#define DEFAULT_FIM_FILE_LIMIT       100000
#define DEFAULT_FIM_REGISTRY_LIMIT   100000

/* Syscollector default values */
#define DEFAULT_SYSCOLLECTOR_HOTFIXES      1000
#define DEFAULT_SYSCOLLECTOR_PACKAGES      50000
#define DEFAULT_SYSCOLLECTOR_PROCESSES     50000
#define DEFAULT_SYSCOLLECTOR_PORTS         50000
#define DEFAULT_SYSCOLLECTOR_NETWORK_IFACE 100
#define DEFAULT_SYSCOLLECTOR_NETWORK_PROTO 100
#define DEFAULT_SYSCOLLECTOR_NETWORK_ADDR  100
#define DEFAULT_SYSCOLLECTOR_HARDWARE      1
#define DEFAULT_SYSCOLLECTOR_OS_INFO       1
#define DEFAULT_SYSCOLLECTOR_USERS         50
#define DEFAULT_SYSCOLLECTOR_GROUPS        100
#define DEFAULT_SYSCOLLECTOR_SERVICES      10000

/* SCA default values */
#define DEFAULT_SCA_CHECKS           10000
