...
protected:
    ...
    void SetUp() override {
        ...
        bpf_helpers->ebpf_pop_events             = mock_ebpf_pop_events; // por defecto, sin barrera
        bpf_helpers->ring_buffer_poll            = (ring_buffer__poll_t)mock_ring_buffer_poll_success_barrier; // valor razonable por defecto
    }
